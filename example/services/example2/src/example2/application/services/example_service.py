...
from example2_service.domain.entities.example import ExampleEntity
from example2_service.domain.ports.repositories.example_repository_port import ExampleRepositoryPort
...
_example2_service: ExampleService | None = None


def initialize_example2_service(repository: ExampleRepositoryPort | None = None) -> ExampleService:
    ...
    """
    global _example2_service
    if repository is None:
        from example2_service.infrastructure.repositories.example_repository import ExampleRepository
        repository = ExampleRepository()
    _example2_service = ExampleService(repository)
    return _example2_service


def get_example2_service() -> ExampleService:
    ...
    """
    global _example2_service
    if _example2_service is None:
        _example2_service = initialize_example2_service()
    return _example2_service
