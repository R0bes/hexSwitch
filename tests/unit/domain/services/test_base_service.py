...
@dataclass
class SampleEntity:  # noqa: PLR0903
...
class MockRepository(BaseRepositoryPort[SampleEntity]):  # noqa: PLR0903
...
class SampleService(BaseService[SampleEntity, MockRepository]):  # noqa: PLR0903
